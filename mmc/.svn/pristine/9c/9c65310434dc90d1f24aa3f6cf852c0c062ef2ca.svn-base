		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-header">
					<h3 class="box-title">DAFTAR PASIEN PATOLOGI ANATOMI</h3>
				</div>
				<div class="box-body ">
					<?php echo form_open('pa/pacdaftar/by_date');?>
					<div class="col-xs-3">
					...
					<?php echo form_close();?>
					<?php echo form_open('pa/pacdaftar/by_no');?>
					<div class="col-xs-3">
						<div class="input-group">
					...
					<?php echo form_open('pa/pacdaftar/daftar_pasien_luar');?>
						...
						<tbody>
							...
							<tr>
								...
								<td><?php echo $row->bed;?></td>
							  	<td>
									<a href="<?php echo site_url('pa/pacdaftar/pemeriksaan_pa/'.$no_register); ?>" class="btn btn-primary btn-xs">Tindak</a>
							  	</td>
							</tr>
							<?php } ?>
						</tbody>
