...
class Admin extends Secure_area {
	...
	public function userList() {
		...
		foreach ($hasil as $value) {
			...
			$row2['plus'] = '<center><a href="#" type="button" class="btn btn-primary btn-xs" title="Akses Gudang" data-toggle="modal" data-target="#myModalGdg" onclick="setUserGudang('.$value->userid.',\''.$value->username.'\')" ><i class="fa fa-building fa-fw"></i></a></center>';
			$row2['poli'] = '<center><a href="#" type="button" class="btn btn-primary btn-xs" title="Akses Poli" data-toggle="modal" data-target="#myModalPoli" onclick="setUserPoli('.$value->userid.',\''.$value->username.'\')" ><i class="fa fa-building fa-fw"></i></a></center>';
			$row2['ruang'] = '<center><a href="#" type="button" class="btn btn-primary btn-xs" title="Akses Ruang" data-toggle="modal" data-target="#myModalRuang" onclick="setUserRuang('.$value->userid.',\''.$value->username.'\')" ><i class="fa fa-building fa-fw"></i></a></center>';
