  ...
  <div class="panel panel-default">
    ...
    <div class="panel panel-body">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-6">
          <input type="text" id="date_picker2" class="form-control" placeholder="Kontra Bon" name="tgl_kontra_bon" required>
        </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-6">
          <input type="text" id="date_picker" class="form-control" placeholder="Jatuh Tempo" name="jatuh_tempo" required>
        </div>
      </div>
