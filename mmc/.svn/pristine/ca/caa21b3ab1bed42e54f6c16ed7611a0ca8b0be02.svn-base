		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-header">
					<h3 class="box-title">PENGISIAN HASIL PATOLOGI ANATOMI</h3>
				</div>
				<div class="box-body">
					...
					<table id="example" class="display" cellspacing="0" width="100%">
						...
						<tbody>
							...
							<tr>
							  	...
							  	<td>
									<a href="<?php echo site_url('pa/pacpengisianhasil/daftar_hasil/'.$row->no_pa); ?>" class="btn btn-primary btn-xs">Hasil Pemeriksaan</a>
							 	</td>
							<?php } ?>
						</tbody>
					</table>
