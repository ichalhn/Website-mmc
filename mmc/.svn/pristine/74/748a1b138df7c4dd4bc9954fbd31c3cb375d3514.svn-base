					...
					<?php echo $this->session->flashdata('pesan');?>
						<div class="panel panel-info">
							<div class="panel-body">
								<br/>
						<div style="display:block;overflow:auto; resposive-table">
						  	...
						  	<tr>
								...
								?>
						  		...
						  		<td><?php echo $r['dokter']?></td>
						  								  		<td><?php if($r['carabayar']=='DIJAMIN'){ echo $r['nmkontraktor']; } else echo $r['carabayar']; ?></td>
						  		<td>
						  		...
						  		<a href="<?php echo base_url(); ?>iri/ricreservasi/index/<?php echo $r['no_ipd']?>"><button type="button" class="btn btn-default btn-sm"><i class="fa fa-plusthick"></i> Mutasi</button></a>
    ...
    <div class="modal-dialog modal-success">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Ganti Ruangan</h4>
          <p>* selama belum ada record tindakan di ruangan</p>
        </div>
    ...
    $.ajax({
        ...
        {          
            ...
            if(data.sukses){
              ...
              alert('Sudah terdapat tindakan, tidak bisa ganti ruangan !');
            }
        },
