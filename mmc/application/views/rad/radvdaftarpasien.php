		...
		<div class="col-xs-12">
			<div class="box">
				<!-- <div class="box-header">
					<h3 class="box-title">DAFTAR PASIEN RADIOLOGI</h3>
				</div> -->
				<div class="box-body">
					...
					<div class="modal fade" id="myModal" role="dialog">
						<div class="modal-dialog modal-success" data-backdrop="static" data-keyboard="false">
						...
						<tbody>
							...
							<tr>
								...
								<td><?php echo $row->bed;?></td>
							  	<td>
									<a href="<?php echo site_url('rad/radcdaftar/pemeriksaan_rad/'.$no_register); ?>" class="btn btn-primary btn-xs">Tindak</a>
							  	</td>
							</tr>
							<?php } ?>
						</tbody>
