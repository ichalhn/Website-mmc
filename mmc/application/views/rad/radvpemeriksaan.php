			...
			<div class="panel panel-default">	
				...
				<div class="panel-body" style="display:block;overflow:auto;">
					...
					<?php 
						...
						<div class="form-group row">
							<p class="col-sm-2 form-control-label" id="lbl_biaya_rad">Biaya Pemeriksaan</p>
							<div class="col-sm-3">
				        ...
				        <div class="col-xs-12">
				          	<div class="box">
					            ...
					            <div class="box-body table-responsive no-padding">
					              	<table id="tabel_rad" class="table table-hover">
										<thead>
											<tr>
											  	<th>No</th>
										...
										?>
											<tr>
												...
												<td>
													<a class="btn btn-danger btn-xs" href="javascript:void()" title="Hapus" onclick="hapus_data_pemeriksaan(<?php echo $row->id_pemeriksaan_rad ; ?>)">Hapus</a>
												</td>
											</tr>
										<?php
											}
