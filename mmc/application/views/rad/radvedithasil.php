				...
				<div class="col-sm-12">
					<div class="panel panel-default">	
						<div class="panel-heading" align="center">	
							<h4  align="center">Edit Hasil Pemeriksaan</h4>
						</div>
						...
						<br/>
							...
							<?php echo form_open_multipart('rad/radcpengisianhasil/update_hasil'); ?>
								<div class="form-group row">
									<p class="col-sm-3 form-control-label" id="lbl_gambar_hasil">Foto Hasil Radiologi</p>
									<div class="col-sm-8">
									<?php 
								...
								<div class="form-group row">
									...
									<div class="col-sm-8">
										<textarea rows="10" cols="80" name="hasil_periksa" id="hasil_periksa"><?php echo $hasil_periksa; ?></textarea>
									</div>
								</div>
