					...
					<table id="example" class="display" cellspacing="0" width="100%">
						...
						<tbody>
							...
							<tr>
							  	...
							  	<td>
									<a href="<?php echo site_url('lab/labcdaftarhasil/view_pdf/'.$row->no_lab); ?>" class="btn btn-primary btn-xs" target="_blank">Lihat Hasil</a>
									<a href="<?php echo site_url('lab/Labcpengisianhasil/daftar_hasil/'.$row->no_lab); ?>" class="btn btn-primary btn-xs">Edit Hasil</a>
							 	</td>
							<?php } ?>
						</tbody>
					</table>
