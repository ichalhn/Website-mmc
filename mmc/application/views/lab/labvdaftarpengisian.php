					...
					<table id="example" class="display" cellspacing="0" width="100%">
						...
						<tbody>
							...
							<tr>
							  	...
							  	<td><?php echo $row->no_register;?>
							  		<?php 
							  		if ($roleid=='1' || $roleid=='32'){
							  		echo '<a href="'.site_url('lab/labcdaftar/daftar_pemeriksaan/'.$row->no_register).'" target="_blank" class="btn btn-primary btn-xs">List Item Pemeriksaan</a>';
							  		}?>
							  	</td>
