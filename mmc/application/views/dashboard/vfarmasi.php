  ...
  function pilih_obat() {
    ...
    if(tgl_awal!="" && tgl_akhir!=""){
      ...
      $.ajax({
        type:'POST',
        dataType: 'json',
        url:"<?php echo base_url('Cdashboard/get_data_obat')?>",
        data: {
          tgl_akhir : tgl_akhir,
          tgl_awal : tgl_awal
        },
          ...
          <div class="col-sm-10">
            <div class="form-inline">
              <div class="form-group">
                ...
                <button class="btn btn-primary" type="submit" onclick="pilih_obat()">Cari</button>
              </div>
            </div>
          </div>
          <div hidden class="chart" id="obat" style="height: 450px;"></div>
