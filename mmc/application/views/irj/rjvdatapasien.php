			...
			<div class="col-sm-5">
				<div class="panel panel-default">
						...
						<table class="table-sm table-striped" style="font-size:15">
						  <tbody>
						  	<tr>
								...
								<td>:&nbsp;</td>
								<td style="color:green !important"><b><?php echo $data_pasien_daftar_ulang->no_antrian; if($data_pasien_daftar_ulang->shift=='' or $data_pasien_daftar_ulang->shift==null){
									$shift='';
									}else if($data_pasien_daftar_ulang->shift=='P'){
										$shift=' - PAGI';
									}else if ($data_pasien_daftar_ulang->shift=='S') {
										$shift=' - SORE';
									} echo $shift;?></b></td>
							</tr>
							<tr>
					...
					<span class="input-group-btn">
						<a type="button" class="btn btn-success pull-right" href="<?php echo site_url()."medrec/Rme/histori/".$data_pasien_daftar_ulang->no_cm;?>" target="_blank"><i class="fa fa-binoculars">&nbsp; Rekam Medik</i> </a>
					</span>
			</div>
			</div>
			</div>
											...
											<label class="checkbox-inline">
												...
												if($rujukan_penunjang->ok=='1'){
													if($rujukan_penunjang->status_ok=='0'){
														...
														echo '<input type="checkbox" id="ok1" name="ok1" value=null checked disabled> Operasi';
													} else {
