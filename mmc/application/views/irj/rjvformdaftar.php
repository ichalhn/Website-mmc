...
$(function() {
  ...
  //   $( function() {
     //   $( "#date_picker1" ).datepicker( "option", "dateFormat", "dd-mm-yyyy" );
     // } 
	 // )
	 ; 
				...
				<div class="panel panel-info">
					<div class="panel-body">
						...
						<div class="col-sm-12">
                            ...
                            <div class="form-group row">
									<p class="col-sm-3 form-control-label" >No Medical Record*</p>									
									<div class="col-sm-8">
										<div class="form-inline">
										<input type="text" size="2" maxlength="2" class="form-control" name="cm1" > - 
									
										<input type="text" size="2" maxlength="2" class="form-control" name="cm2" > - 
									
										<input type="text" size="2" maxlength="2" class="form-control" name="cm3" > 
									</div>
									</div>	
								</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" id="" maxDate="0" placeholder="dd-mm-yyyy" name="tgl_lahir" required>
								</div>
							</div>
							<div class="form-group row">
