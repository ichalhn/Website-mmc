...
function pilih_cara_bayar(val_cara_bayar){
	...
	}else if(val_cara_bayar=='DIJAMIN'){
		$('#input_diagnosa').show();
		$('#warn_kartu').show();
		$('#input_kontraktor').show();
...
function cek_no_nrp(no_nrp, no_nrp_old){
	$.ajax({
		type:'POST',
		dataType: 'json',
		url:"<?php echo base_url('irj/rjcregistrasi/cek_available_nonrp')?>/"+no_nrp+"/"+no_nrp_old,
		success: function(data){
			//alert(data);
			if (data>0) {
				//alert("No Kartu '"+no_kartu+"' Sudah Terdaftar ! <br> Silahkan masukkan no kartu lain...");
...
<?php $url=site_url('irj/rjcregistrasi/cetak_identitas/').'/'.$data_pasien->no_cm; ?>
										<a href="<?php echo $url ?>" target="_blank" class="btn btn-danger" type="button"><i class="fa fa-print"></i> Cetak Identitas</a>										
									<?php echo form_close();?>
							...
							<?php echo form_open_multipart('irj/rjcregistrasi/update_data_pasien');?>
								...
								<div class="form-group row">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" value="<?php echo date('d-m-Y',strtotime($data_pasien->tgl_lahir));?>" name="tgl_lahir" required>
									</div>
								</div>
								<div class="form-group row">
											...
											<div class="form-group">
												<?php 
													if($data_pasien->status=='B'){
														echo '<input type="radio" name="status" value="B" checked required>&nbsp;Belum Menikah&nbsp;&nbsp;&nbsp;
														<input type="radio" name="status" value="K">&nbsp;Sudah Menikah
														<input type="radio" name="status" value="C" >&nbsp;Cerai';
													}else if($data_pasien->status=='K'){
														echo '<input type="radio" name="status" value="B" required>&nbsp;Belum Menikah&nbsp;&nbsp;&nbsp;
														<input type="radio" name="status" value="K" checked>&nbsp;Sudah Menikah
														<input type="radio" name="status" value="C" >&nbsp;Cerai';
													}else if ($data_pasien->status=='C'){
														echo '<input type="radio" name="status" value="B" required>&nbsp;Belum Menikah&nbsp;&nbsp;&nbsp;
														<input type="radio" name="status" value="K">&nbsp;Sudah Menikah
														<input type="radio" name="status" value="C" checked>&nbsp;Cerai';
													}else{
														echo '<input type="radio" name="status" value="B" required>&nbsp;Belum Menikah&nbsp;&nbsp;&nbsp;
														<input type="radio" name="status" value="K">&nbsp;Sudah Menikah
														<input type="radio" name="status" value="C">&nbsp;Cerai';
								...
								<div class="form-group row">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" value="<?php echo $data_pasien->alamat;?>" name="alamat" required>
									</div>
								</div>
								<div class="form-group row">
				...
				<div class="panel panel-info">
					...
					<br>
							...
							<input type="hidden" value="<?php echo $data_pasien->no_kartu;?>" name="no_kartu">
								<div class="form-group">
									<p class="col-sm-2 control-label" id="jns_kunj">Jenis Kunjungan</p>
									<div class="col-sm-8">
								...
								<div class="form-group">
									<p class="col-sm-2 control-label">Tanggal Kunjungan</p>
									<div class="col-sm-5">
										<input type="text" class="form-control date_picker" name="tgl_kunjungan" value="<?php echo date('Y-m-d');?>">
									</div>
								</div>
								<div class="form-group">
									<p class="col-sm-2 control-label" >Cara Kunjungan *</p>
									<div class="col-sm-5">
								...
								<div class="form-group">
									<p for="cara_bayar" class="col-sm-2 control-label" id="lbl_cara_bayar">Cara Bayar *</p>
									<div class="col-sm-5">
										<div class="form-inline">
								...
								<div class="form-group" id="warn_kartu">
								...
								<div class="form-group">
									<p class="col-sm-2 control-label">Asal Rujukan</p>
									<div class="col-sm-5">
								...
								<div class="form-group" id="rujukan_lainnya">
									<p class="col-sm-2 control-label"></p>
									<div class="col-sm-5">
								...
								<div class="form-group">
									<p class="col-sm-2 control-label">No. SJP/Rujukan</p>
									<div class="col-sm-5">
								...
								<div class="form-group">
									<p class="col-sm-2 control-label" id="dirujuk_ke">Tujuan Poliklinik*</p>
									<div class="col-sm-5">
										<div class="form-inline">
								...
								<div id="ird">
									<div class="form-group">
										<p class="col-sm-2 control-label" id="alber">Alasan Berobat</p >
											<div class="col-sm-5">
									...
									<div class="form-group">
										<p class="col-sm-2 control-label" id="pasdatDg">Datang dengan</p>
										<div class="col-sm-5"><select class="form-control" name="pasdatDg" required>
											<option value="klg">Keluarga</option>
											<option value="ttg">Tetangga</option>
											<option value="lain">Lain-lain</option>
										</select></div>
									</div>								
									<div class="form-group" id="input_kecelakaan">
										<p class="col-sm-2 control-label" id="Kclkaan">Kecelakaan</p>
										<div class="col-sm-5">
								...
								<div class="form-group" id="list_dokter">
									<p class="col-sm-2 control-label" id="dokter">Dokter</p>
									<div class="col-sm-5">
										<div class="form-inline">
								...
								<div class="form-group" id="input_diagnosa">
									<p class="col-sm-2 control-label" id="lbl_input_diagnosa">Diagnosa</p>
									<div class="col-sm-8">
								...
								<div class="form-group" id="hubungan">
									<p class="col-sm-2 control-label" >Hubungan</p>
									<div class="col-sm-5">
										<div class="form-inline">
								...
								<div class="form-group">
									<p class="col-sm-2 control-label" id="catatan">Catatan</p>
									<div class="col-sm-5">
							...
							<button type="submit" class="btn btn-danger" id="button_cetak_sep"><i class="fa fa-print"></i> Simpan & Cetak SEP</button>
									</div>
								</div>
							<?php echo form_close();
							?>
