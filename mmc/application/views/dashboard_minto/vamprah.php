                    ...
                    <div class="card-block chart-responsive">
                        ...
                        <table class="display nowrap table table-hover table-bordered dataTable" id="example" style="font-size: 14px; border: 2px solid black;" >
                            ...
                            <tr style="border: 2px solid black;">
                                ...
                                <td style="border: 2px solid black; vertical-align: middle;" align="center">Gudang Distribusi</td>
                                <td style="border: 2px solid black; vertical-align: middle;" align="center">Jumlah Amprah</td>
                                <td style="border: 2px solid black; vertical-align: middle;" align="center">Jumlah Distribusi</td>
