					...
					<table id="example" class="display" cellspacing="0" width="100%">
						...
						?>
							<tr>
							  ...
							  <td>
									<a href="<?php echo site_url('faktur/fcrekap/faktur_rad/FKTR_'.$no_rad.'.pdf'); ?>" target="_blank"class="btn bg-orange btn-sm" style="width:63px; margin:2px;">Faktur</a>
									<a href="<?php echo site_url('faktur/fcrekap/kwitansi_rad/KW_'.$no_rad.'.pdf'); ?>" target="_blank" class="btn btn-primary btn-sm" style="width:63px; margin:2px;">Kwitansi</a>
							  </td>
							</tr>
						<?php
							}
