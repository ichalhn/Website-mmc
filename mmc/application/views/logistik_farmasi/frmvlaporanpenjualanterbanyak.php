...
<script type='text/javascript'>
    ...
    function download(){
        ...
        swal({
                title: "Download?",
                text: "Download Laporan Penjualan Obat Terbanyak!",
                type: "warning",
            ...
            function(isConfirm){
                if (isConfirm) {
                    ...
                    window.open("<?php echo base_url('logistik_farmasi/frmclaporan/download_penjualan_terbanyak')?>/"+startDate+"/"+endDate+"/"+filter);
                } else {
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="form-group">
                        <div class="col-lg-4">
                            <label>Limit Data Sebanyak</label>
                        </div>
                        <div class="col-lg-6">
                            <select name="filter" id="filter" class="form-control" style="width:100%" required="">
                                <option value="100">100 Data Terlaris</option>
                                <option value="300">300 Data Terlaris</option>
                                <option value="500">500 Data Terlaris</option>
                                <option value="1000">1.000 Data Terlaris</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
