...
var det_item_id, det_id_po, det_jml_kemasan, det_harga_po, det_satuan_item, det_diskon_persen;
$(function() {
	...
	$('#btnAcc').click( function() {
		...
		if (idata >= 0){
			$.ajax({
			  ...
			  data: {json: vdata },
			  type: "POST",
			  url: "//echo site_url(); ?>logistik_farmasi/Frmcpembelian_po/alokasi",
			  success: function( response ) {
										...
										<td width="100%" valign="top">
											<table id="tableObat" class="display" cellspacing="0" width="100%">
											  ...
											  <tr>
												...
												<th><p align="center">diskon_persen</p></th>
												<th></th>
											  </tr>
											  </thead>
											</table>	
