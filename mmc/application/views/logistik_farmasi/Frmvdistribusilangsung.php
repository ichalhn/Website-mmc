                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select name="gd_dituju" id="gd_dituju" class="form-control js-example-basic-single" required>
                                        <?php
                            ...
                            <input type="hidden" id="gd_asal" name="gd_asal"/>
                        </div>
