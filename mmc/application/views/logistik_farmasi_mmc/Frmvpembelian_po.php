...
$(function() {
	...
	tableObat = $('#tableObat').DataTable({
		// ajax: "<?php echo site_url(); ?>logistik_farmasi/Frmcpembelian_po/get_detail_beli",
		columns: [
			{ data: "description" },
			{ data: "satuank" },
			{ data: "qty_po", render: $.fn.dataTable.render.number('.', ',', 0, '') },
			{ data: "harga_item", render: $.fn.dataTable.render.number('.', ',', 0, '') },
			{ data: "subtotal" },
										...
										<td width="100%" valign="top">
											<table id="tableObat" class="display" cellspacing="0" width="100%">
											  ...
											  <tr>
												...
												<th><p align="center">Harga Item</p></th>
