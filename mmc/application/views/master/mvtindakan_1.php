...
<script type='text/javascript'>
  ...
  function edit_tindakan(idtindakan) {
    ...
    $.ajax({
      type:'POST',
      dataType: 'json',
      url:"<?php echo base_url('master/mctindakan_1/get_data_edit_tindakan')?>",
      data: {
  ...
  function download_excel() {
    window.location.href = "<?php echo base_url('master/mctindakan_1/export_excel')?>";
  }
  ...
  function edit()
  {
    ...
    url = "<?php echo site_url('master/mctindakan_1/edit_tindakan')?>";  
    ...
    <div class="col-xs-12">
      <div class="box">
        ...
        <div class="box-body ">
          ...
          <?php echo form_open('master/mctindakan_1/insert_tindakan');?>
          <div class="col-xs-3">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <?php
                            ...
                            foreach($kelas as $row){
                              echo '<tr>
                                      <td>'.$row->kelas.'</td>
                                      <td>
                                        <input value="0" type="number" class="form-control" name="jasa_sarana_'.$row->kelas.'" id="jasa_sarana_'.$row->kelas.'" step="100" min="0" onchange="set_total_'.$row->kelas.'(this.value)">
                                      </td>
                                      <td>
                                        <input value="0" type="number" class="form-control" name="jasa_pelayanan_'.$row->kelas.'" id="jasa_pelayanan_'.$row->kelas.'" step="100" min="0" onchange="set_total_'.$row->kelas.'(this.value)">
                                      </td>
                                      <td>
                                        <input value="0" disabled type="text" class="form-control" name="total_'.$row->kelas.'" id="total_'.$row->kelas.'" step="100" min="0">
                                        <input value="0" type="hidden" class="form-control" name="hidden_total_'.$row->kelas.'" id="hidden_total_'.$row->kelas.'" step="100" min="0">
                                      </td>
                                    </tr>';
                            }
                        ?>
                  ...
                  <?php
                      ...
                      //     <div class="col-sm-4">
                      //       <input type="number" class="form-control" name="kelas_'.$row->kelas.'" id="kelas_'.$row->kelas.'" step="100" min="0">
                      //     </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a type="button" class="btn btn-danger btn-xs" href="<?php echo base_url('master/mctindakan_1/delete_tindakan/'.$row->idtindakan)?>" ><i class="fa fa-trash"></i></a>
                </td>
              </tr>
              <?php } ?>
            </tbody>
                ...
                <div class="modal-body">
                  <form action="#" id="formedit" class="form-horizontal">
                          ...
                          <?php
                              ...
                              foreach($kelas as $row){
                                echo '<tr>
                                        <td>'.$row->kelas.'</td>
                                        <td>
                                          <input value="0" type="number" class="form-control" name="edit_jasa_sarana_'.$row->kelas.'" id="edit_jasa_sarana_'.$row->kelas.'" step="100" min="0" onchange="edit_set_total_'.$row->kelas.'(this.value)">
                                        </td>
                                        <td>
                                          <input value="0" type="number" class="form-control" name="edit_jasa_pelayanan_'.$row->kelas.'" id="edit_jasa_pelayanan_'.$row->kelas.'" step="100" min="0" onchange="edit_set_total_'.$row->kelas.'(this.value)">
                                        </td>
                                        <td>
                                          <input value="0" disabled type="text" class="form-control" name="edit_total_'.$row->kelas.'" id="edit_total_'.$row->kelas.'" step="100" min="0">
                                          <input value="0" type="hidden" class="form-control" name="edit_hidden_total_'.$row->kelas.'" id="edit_hidden_total_'.$row->kelas.'" step="100" min="0">
                                        </td>
                                      </tr>';
                              }
                          ?>
                    ...
                    <?php
                        ...
                        //           <p class="col-sm-2 form-control-label" id="lbl_nama">Tarif Kelas '.$row->kelas.'</p>
                        //           <div class="col-sm-4">
                        //             <input type="number" class="form-control" name="edit_kelas_'.$row->kelas.'" id="edit_kelas_'.$row->kelas.'" step="100" min="0">
                        //           </div>
                        //         </div>';
                        // }
                    ?>
