									...
									<div class="row">
														...
														<?php
															if(isset($data_pasien[0]['no_register'])){
																$kode = substr($data_pasien[0]['no_register'], 0,2);
																	switch ($kode) {
																		case 'RJ':
																			echo '<div class="col-sm-4 input-left"><input type="text" class="form-control input-sm" name="id_poli" id="id_poli" disabled="true" value="'.$data_pasien[0]['id_poli'].'" ></div>
																<div class="col-sm-8 input-right"><input type="text" class="form-control input-sm" name="poliasal" id="poliasal" disabled="true" value="'.$data_pasien[0]['nm_poli'].'"  ></div>';
																			break;
																		case 'RD':
																			echo '<div class="col-sm-4 input-left"><input type="text" class="form-control input-sm" name="id_poli" id="id_poli" disabled="true" value="BB99" ></div>
																<div class="col-sm-8 input-right"><input type="text" class="form-control input-sm" name="poliasal" id="poliasal" disabled="true" value="POLI UGD"  ></div>';
																			break;
																		case 'RI':
																			echo '<div class="col-sm-4 input-left"><input type="text" class="form-control input-sm" name="id_poli" id="id_poli" disabled="true" value="'.$data_pasien[0]['idrg'].'" ></div>
																<div class="col-sm-8 input-right"><input type="text" class="form-control input-sm" name="poliasal" id="poliasal" disabled="true" value="'.$data_pasien[0]['nmruang'].'"  ></div>';
																			break;
																		default:
																			# code...
																			break;
										...
										<div class="col-sm-6">
											<div class="box-body">
												...
												<input type="hidden" value="<?php echo $mutasi; ?>" name="mutasi" id="mutasi">
												<div class="form-group">
