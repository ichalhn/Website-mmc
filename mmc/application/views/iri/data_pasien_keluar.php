...
function set_total(val){
   ...
   /*if(parseInt(obat)!=0){
      ...
      // }      
      biaya_awal=parseInt(total)+parseInt(biaya_administrasi)+parseInt(jasa_perawat)+parseInt(biaya_daftar)+6000;
   }*/

	var biaya_akhir = parseInt(dibayar_tunai); //+ parseInt(dibayar_kartu_cc_debit) + parseInt(total_charge);
   var total_harga_gabungan = parseInt(biaya_awal) - parseInt(diskon) + parseInt(denda);
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td>
                                    ...
                                    <a href="<?php echo base_url();?>iri/ricstatus/cetak_list_pembayaran_pasien/<?php echo $data_pasien[0]['no_ipd'].'/1';?>" target="_blank"><input type="button" class="btn btn-primary btn-sm" value="Cetak Faktur"></a>

                                    <br><br>
                                    <a href="<?php echo base_url();?>iri/ricstatus/cetak_list_pembayaran_pasien/<?php echo $data_pasien[0]['no_ipd'].'/0';?>" target="_blank"><input type="button" class="btn btn-primary btn-sm" value="Lihat Kwitansi Sementara"></a>
                                 </td>
                                 <input type="hidden" value="<?php echo $data_pasien[0]['no_ipd'];?>" name="no_ipd" id="no_ipd">                                 
                              </tr>
                              <tr>
