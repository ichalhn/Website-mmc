...
<div >
			...
			<div class="inline">
				<div class="row">
					<div class="form-inline">
						<form action="<?php echo base_url();?>iri/riclaporan/pendapatan_all" method="post" accept-charset="utf-8">
						<div class="col-lg-10">
							<div class="form-inline">
		...
		<section class="content">
				<div class="row">
						<div class="panel panel-info">
							<div class="panel-heading" align="center" >Laporan Pendapatan <?php //echo $user_show; ?><br> 
	...
	*/
                            ...
                            //   print_r($list_keluar_irj);die();

						  		$total = $total + $r['vtot'] + $r['vtot_rad'] + $r['vtot_lab'] + $r['vtot_obat'] + $r['vtot_lain']+ $r['vtot_ok'] ;
						  		$total_bayar_tunai = $total_bayar_tunai + $r['tunai'];
						  	//	$total_dibayar_kartu_kredit = $total_dibayar_kartu_kredit + $r['nilai_kkkd'];
						  	//	$total_charge_kartu_kredit = $total_charge_kartu_kredit + ($r['nilai_kkkd'] * $r['persen_kk'] / 100);
						  	?>
						  	<tr>
						  		<td><?php 						  		
						  		echo date('d-m-Y',strtotime($r['tgl_cetak_kw']));
						  		?></td>
						  		<td><?php echo $r['asal']?></td>
						  		<td><?php echo $r['no_register']?></td>
						  		<td><?php echo strtoupper($r['nama'])?></td>
						  		<td><?php  echo $r['nm_poli']?></td>
						  		<td><?php if($r['cara_bayar'] == 'UMUM'){
						  		 	echo $r['cara_bayar'];
						  		 }else{
						  		 	echo $r['nmkontraktor'];
						  		 }
                                 ...
                                 <?php // hitung total?>
						  		<td align="right">Rp. <?php echo number_format($r['vtot'] + $r['vtot_rad'] + $r['vtot_lab'] + $r['vtot_obat']+$r['vtot_lain']+ $r['vtot_ok'],0);?></td> 
						  		...
						  		<!--  vtot-diskon -->
						  		 ...
						  		 <!-- <td align="right">Rp. <?php //echo number_format($r['vtot'] + $r['vtot_rad'] + $r['vtot_lab'] + $r['vtot_obat']+$r['vtot_lain']+ $r['vtot_ok'] - $diskon,0);?></td> -->
						  		
						  		<td align="right">Rp. <?php echo number_format($r['tunai'],0);?></td>
						  		<td><?php  echo $r['xcetak']?></td>
						  <!-- 		<td align="right">Rp. <?php //echo number_format($r['nilai_kkkd'],0);?></td>
						  		<td align="right">Rp. <?php //echo number_format($r['nilai_kkkd'] * $r['persen_kk'] / 100,0);?></td> -->
						  	</tr>
						  	<?php
						...
						<div class="form-inline" align="right">
							<div class="form-group">
								...
								<a target="_blank" href="<?php echo site_url('iri/riclaporan/cetak_laporan_harian_excel/');?><?php echo '/'.$tgl_awal.'/'.$tgl_akhir;?>"><input type="button" class="btn 
