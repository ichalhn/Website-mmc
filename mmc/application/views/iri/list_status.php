...
<br>
<?php if($state==''){$this->load->view("iri/data_pasien"); }?>
						...
						<div class="tab-content">
							...
							<div class="tab-pane" id="resep_pasien">
								<table width="100%" class="table table-hover table-striped table-bordered data-table" id="dataTables-example7">
								  ...
								  <tbody>
								  	<?php
                                    $total = 0; //Total Untuk Umum
									if(!empty($list_resep)){
										foreach($list_resep as $r){
                                            if($data_pasien[0]['carabayar'] != 'UMUM'){
                                                $vtot = $r['vtot'];
                                            }else{
                                                $vtot = roundUpToNearestHundred($r['vtot']);
                                            }
										...
										<tr>
											...
											<td><?php echo $r['qty'] ; ?></td>
											<td>Rp. <?php echo number_format($vtot, 0) ; ?></td>
                                ...
                                <?php
                                $total_bayar = 0; //Total Untuk BPJS
                                if($data_pasien[0]['carabayar'] == 'BPJS') {
                                    foreach ($list_resep_subtotal as $row) {
                                        $subtotal = roundUpToNearestThousand($row['subtotal']);
                                        $total_bayar += $subtotal;
                                        ?>
                                        <div class="form-inline" align="right">
                                            <div class="col-sm-6"></div>
                                            <div class="form-group row col-sm-6">
                                                <p class="col-sm-6 form-control-label" align="center">Total Resep
                                                    No. <?= $row['no_resep'] ?></p>
                                ...
                                <div class="form-inline" align="right">
                                    <div class="col-sm-6"></div>
                                    <div class="form-group row col-sm-6">
                                        <h3 class="col-sm-6 form-control-label" align="center">Total Semua Resep</h3>
                                        <div class="col-sm-6" align="right">
                                            <h3>Rp. <?php
                                                if($data_pasien[0]['carabayar'] == 'BPJS'){
