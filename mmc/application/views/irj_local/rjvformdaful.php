...
<div class="panel panel-info">					
					...
					<div class="panel-body" id="biodataIRD">
						...
						<div style="margin-left:18px;margin-right:18px;">
								...
								<div class="form-group row">
								<!----------------- ---->
									<p class="col-sm-4 form-control-label" >Cara Kunjungan *</p>
									<div class="col-sm-8">
								...
								<div class="form-group row">
									<p class="col-sm-4 form-control-label" id="dirujuk_ke">Tujuan Poliklinik*</p>
									<div class="col-sm-8">
								...
								<div class="form-group row">
									<p class="col-sm-4 form-control-label" id="dokter">Dokter *</p>
									<div class="col-sm-8">
										<div class="form-inline">
								...
								<div class="form-group row">
									...
									<div class="col-sm-8"><select class="form-control" name="pasdatDg" id="pasdatDg">									
								...
								<div class="form-inline" align="right">
									<div class="form-group">
										...
										<a href="<?php echo site_url('irj/rjcregistrasi/cetak_sep/'.$no_register);?>" target="_blank" class="btn btn-primary" id="btn-cetak-sep">Cetak SEP</a>
