<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	function get_data_hasil_lab($id_jenis_hasil_lab){
			return $this->db->query("SELECT a.*, b.nmtindakan  FROM jenis_hasil_lab as a, jenis_tindakan as b WHERE a.id_jenis_hasil_lab='$id_jenis_hasil_lab' and a.id_tindakan = b.idtindakan");
		}

			function edit_jenis_hasil_lab($id_jenis_hasil_lab, $data){
