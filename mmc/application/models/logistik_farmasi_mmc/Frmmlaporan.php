...
/////////////////////////////////////////////////
		...
		function get_data_distribusi_obat($param1, $param2, $filter){
            ...
            return $this->db->query("SELECT d.`id_obat`, o.`nm_obat`, d.`satuank`, o.`hargajual`, SUM(d.`qty_acc`) AS qty, SUM(d.`qty_acc`) * o.`hargajual` AS subtotal, a.`minggu`, a.gd_asal
                FROM distribusi d
