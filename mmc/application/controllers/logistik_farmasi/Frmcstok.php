...
class Frmcstok extends Secure_area
{
  ...
  public function exceldown($nm_gudang){
    $data['title'] = 'Laporan Gudang RS Marinir Cilandak';
    ...
    $objPHPExcel->getProperties()->setCreator("RS Marinir Cilandak")
            ->setLastModifiedBy("RS Marinir Cilandak")
            ->setTitle("Laporan Gudang RS Marinir Cilandak")
            ->setSubject("Laporan Gudang RS Marinir Cilandak Document")
            ->setDescription("Laporan Gudang RS Marinir Cilandak for Office 2007 XLSX, generated by HMIS.")
            ->setKeywords("RS Marinir Cilandak")
            ->setCategory("Laporan Gudang RS Marinir Cilandak");  
    ...
    $objPHPExcel->getActiveSheet()->setTitle("RS Marinir Cilandak");
  ...
  public function exceldown_so($nm_gudang){
    ...
    $objPHPExcel->getProperties()->setCreator($namars)  
            ...
            ->setTitle("Laporan Gudang RS Marinir Cilandak ".$namars)  
            ->setSubject("Laporan Gudang RS Marinir Cilandak ".$namars." Document")  
            ->setDescription("Laporan Gudang RS Marinir Cilandak ".$namars." for Office 2007 XLSX, generated by HMIS.")  
            ->setKeywords($namars)  
            ->setCategory("Laporan Gudang RS Marinir Cilandak");
  ...
  public function exceldown_hasilso($nm_gudang){
    $nm_gudangreal=str_ireplace("%20"," ",$nm_gudang);    
    $data['title'] = 'Laporan Hasil SO RS Marinir Cilandak '.$nm_gudangreal;
    $namars=$this->config->item('namars');
    $alamat=$this->config->item('alamat');
    $kota_kab=$this->config->item('kota');
