...
class Paclaporan extends Secure_area {
	...
	public function data_kunjungan()
	{
		...
		$data['title'] = 'Laporan Kunjungan Pemeriksaan Patalogi Anatomi';
		...
		if($_SERVER['REQUEST_METHOD']=='POST'){
				...
				if($tampil_per=='TGL'){
					...
					$data['date_title']="Laporan Kunjungan Pasien Patalogi Anatomi <b>$tgl1</b>";
					...
					$data['date_title']="Laporan Kunjungan Pasien Patalogi Anatomi per Hari <b>Bulan $bln3</b>";
					...
					$data['date_title']="Laporan Kunjungan Pasien Patalogi Anatomi <b>Tahun $thn</b>";
					$data['pemeriksaan_title']="Laporan Pemeriksaan :";
					$data['field1']='Bulan';
			...
			$data['date_title']='Laporan Kunjungan Pasien Patalogi Anatomi <b>'.date("d F Y").'</b>';
			$data['tgl']=date("Y-m-d");
			$data['field1']='No. Medrec';
			$data['tampil_per']='TGL';		
	...
	public function data_pendapatan($tampil_per='', $param1='')
	{
		...
		// 		if($tampil_per=='TGL'){
		// 			$tgl=$this->input->post('date_picker_days');
		// 			$data['data_laporan_keu']=$this->pamlaporan->get_data_keu_tind_tgl($tgl)->result();
		// 			$data['data_keuangan']=$this->pamlaporan->get_data_keuangan_tgl($tgl)->result();
		...
		// 			$data['data_laporan_keu']=$this->pamlaporan->get_data_keu_tind_bln($bln)->result();

		// 			$cara_bayar=$this->input->post('jenis_pasien1');	
		// 			$data['jenis_bayar']=$this->input->post('jenis_pasien1');			
		// 			if($cara_bayar==''){
		// 				$data['cara_bayar_pasien']="";
		// 				$data['data_periode']=$this->pamlaporan->get_data_periode_bln($bln)->result();
		// 				$data['data_keuangan']=$this->pamlaporan->get_data_keuangan_bln($bln)->result();
		// 			} else {
		// 				$data['cara_bayar_pasien']="<br><br>Pasien : <b>".$cara_bayar."</b>";
		// 				$data['data_periode']=$this->pamlaporan->get_data_periode_bln_bycarabayar($bln, $cara_bayar)->result();
		// 				$data['data_keuangan']=$this->pamlaporan->get_data_keuangan_bln_bycarabayar($bln, $cara_bayar)->result();
		// 			}
		...
		// 			$thn=$this->input->post('date_picker_years');
		// 			$data['data_laporan_keu']=$this->pamlaporan->get_data_keu_tind_thn($thn)->result();
		// 			$cara_bayar=$this->input->post('jenis_pasien2');	
		// 			$data['jenis_bayar']=$this->input->post('jenis_pasien2');		
		// 			if($cara_bayar==''){
		// 				$data['cara_bayar_pasien']="";
		// 				$data['data_periode']=$this->pamlaporan->get_data_periode_thn($thn)->result();
		// 				$data['data_keuangan']=$this->pamlaporan->get_data_keuangan_thn($thn)->result();
		// 			} else {
		// 				$data['cara_bayar_pasien']="<br><br>Pasien : <b>".$cara_bayar."</b>";
		// 				$data['data_periode']=$this->pamlaporan->get_data_periode_thn_bycarabayar($thn, $cara_bayar)->result();
		// 				$data['data_keuangan']=$this->pamlaporan->get_data_keuangan_thn_bycarabayar($thn, $cara_bayar)->result();
		// 			}
		...
		// 	$this->load->view('pa/pend_today',$data);
		// }else{			
		// 	$data['data_laporan_keu']=$this->pamlaporan->get_data_keu_tindakan_today()->result();
		// 	$data['data_keuangan']=$this->pamlaporan->get_data_keuangan_today()->result();
