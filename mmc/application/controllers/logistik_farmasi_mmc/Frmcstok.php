...
class Frmcstok extends Secure_area
{
  ...
  function index()
    ...
    /*echo "<pre>";
    echo print_r($data['select_gudang']);
    echo "</pre>";*/
	}
  ...
  public function exceldown($nm_gudang){
    $data['title'] = 'Laporan Gudang RS MMC';
    $nm_gudangreal=str_replace("-"," ",$nm_gudang);
    ...
    $objPHPExcel->getProperties()->setCreator("RS MMC")
            ->setLastModifiedBy("RS MMMC")
            ->setTitle("Laporan Gudang RS MMMC")
            ->setSubject("Laporan Gudang RS MMMC")
            ->setDescription("Laporan Gudang RS MMMC for Office 2007 XLSX, generated by HMIS.")
            ->setKeywords("RS MMMC")
            ->setCategory("Laporan Gudang RS MMMC");  
    ...
    $objPHPExcel->getActiveSheet()->setTitle("RS MMMC");
  ...
  public function exceldown_so($nm_gudang){
    ...
    $objPHPExcel->getProperties()->setCreator($namars)  
            ...
            ->setTitle("Laporan Gudang RS MMC ".$namars)  
            ->setSubject("Laporan Gudang RS MMC ".$namars." Document")  
            ->setDescription("Laporan Gudang RS MMC ".$namars." for Office 2007 XLSX, generated by HMIS.")  
            ->setKeywords($namars)  
            ->setCategory("Laporan Gudang RS MMC");
  ...
  public function exceldown_hasilso($nm_gudang){
    $nm_gudangreal=str_ireplace("%20"," ",$nm_gudang);    
    $data['title'] = 'Laporan Hasil SO RS MMC '.$nm_gudangreal;
    $namars=$this->config->item('namars');
    $alamat=$this->config->item('alamat');
    $kota_kab=$this->config->item('kota');
    ...
    $datajson=$this->Frmmstok->get_last_so_by_gudang_name($group)->result();
    //print_r($datajson);break;
    ////EXCEL 
    $this->load->library('Excel');  
    ...
    $objPHPExcel->getProperties()->setCreator($namars)  
            ->setLastModifiedBy($namars)  
            ->setTitle("Laporan Hasil SO RS MMC ".$namars."  ".$nm_gudang)  
            ->setSubject("Laporan Hasil SO RS MMC ".$namars." Document")  
            ->setDescription("Laporan Hasil SO RS MMC ".$namars." for Office 2007 XLSX, generated by HMIS.")  
            ->setKeywords($namars)  
            ->setCategory("Laporan Hasil SO RS MMC");
