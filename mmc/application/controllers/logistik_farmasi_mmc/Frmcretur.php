...
class Frmcretur extends Secure_area
{
    ...
    public function edit_data_retur()
    {
        ...
        $id_gudang = 1;//$group->id_gudang;
        $datajson = $this->Frmmretur->get_data_retur_by_batch($batch_no, $item_id, $id_gudang)->result();
        echo json_encode($datajson);
    }
    ...
    public function edit_data_stok()
    {
      ...
      */
        ...
        if ($this->input->post('edit_quantity_purchased') != 0) {
            ...
            $this->Frmmretur->edit_stok($this->input->post(), $id_gudang);
