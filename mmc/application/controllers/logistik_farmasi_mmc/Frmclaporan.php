...
<hr>
    ...
    public function download_distribusi_obat($param1='', $param2='', $filter='', $nip_serah='', $nip_terima='', $nama_serah='', $nama_terima=''){
        ...
        $objPHPExcel->getProperties()->setCreator($namars)
            ...
            ->setTitle("Laporan Distribusi Obat Gudang YANMASUM")
            ->setSubject("Laporan Distribusi Obat Gudang YANMASUM")
            ->setDescription("Laporan Distribusi Obat Gudang YANMASUM, generated by HMIS.")
            ->setKeywords($namars)
        ...
        $objPHPExcel->getActiveSheet()->SetCellValue('A1', "RUMKITAL MARINIR CILANDAK");
        $objPHPExcel->getActiveSheet()->getStyle('A1')->getFont()->setBold(true);
        ...
        $objPHPExcel->getActiveSheet()->SetCellValue('A8', "Berdasarkan Perintah Kabag Far Rumkital Marinir Cilandak sbb :");
