...
class Radcdaftar extends Secure_area {
	...
	public function index(){
		$data['title'] = 'DAFTAR PASIEN DIAGNOSTIK';
	...
	public function by_date(){
		...
		$data['title'] = 'DAFTAR PASIEN DIAGNOSTIK Tanggal '.$date;
	...
	public function pemeriksaan_rad($no_register=''){
		$data['title'] = 'Input Pemeriksaan Diagnostik';
		...
		$data['data_pemeriksaan']=$this->radmdaftar->get_data_pemeriksaan($no_register)->result();
		...
		if($no_rad!=''){
			...
			$konten="<style type=\"text/css\">
					...
					<table>
						...
						<tr>
							<td align=\"center\" colspan=\"3\"><b>FAKTUR DIAGNOSTIK No. DIA_$no_rad</b></td>
						</tr>
						<tr>
