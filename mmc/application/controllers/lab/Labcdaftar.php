...
class Labcdaftar extends Secure_area {
	...
	public function daftar_pemeriksaan($no_register=''){
		$data['title'] = 'Detail Pemeriksaan Laboratorium';
		...
		if(substr($no_register, 0,2)=="PL"){
			...
			if(substr($no_register, 0,2)=="RJ"){
				$data['data_pasien_pemeriksaan']=$this->labmdaftar->get_data_pasien_pemeriksaan_table_irj($no_register)->result();
			}else if(substr($no_register, 0,2)=="RI"){
				$data['data_pasien_pemeriksaan']=$this->labmdaftar->get_data_pasien_pemeriksaan_table_iri($no_register)->result();
			}
		...
		$data['data_pemeriksaan']=$this->labmdaftar->get_data_pemeriksaan_all($no_register)->result();
		...
		$this->load->view('lab/labvdetailpemeriksaan',$data);
	}
	...
	public function cetak_faktur_by_noreg($no_register='')
	{
		if($no_register!=''){
			...
			$alamatrs=$this->config->item('alamat');
			$nmsingkat=$this->config->item('namasingkat');
			$data_pasien=$this->labmkwitansi->get_data_pasien_byno_register($no_register)->row();
			if (substr($no_register, 0,2) == "RI") {
				$noregasal=$this->labmkwitansi->get_noreg_asal($no_register)->row()->noregasal;
				$data_pemeriksaan=$this->labmkwitansi->get_data_pemeriksaan_byno_register_ri($no_register, $noregasal)->result();
			} else {
				$data_pemeriksaan=$this->labmkwitansi->get_data_pemeriksaan_byno_register($no_register)->result();
			}
			...
			$konten="<style type=\"text/css\">
					...
					<table border=\"1\" style=\"padding:2px\">
						<tr>
							<th width=\"5%\"><p align=\"center\"><b>No</b></p></th>
							<th width=\"7%\"><p align=\"center\"><b>No Lab</b></p></th>
							<th width=\"17%\"><p align=\"center\"><b>Tanggal Tindakan</b></p></th>
							<th width=\"38%\"><p align=\"center\"><b>Nama Pemeriksaan</b></p></th>
							<th width=\"10%\"><p align=\"center\"><b>Biaya</b></p></th>
							<th width=\"10%\"><p align=\"center\"><b>Banyak</b></p></th>
							<th width=\"13%\"><p align=\"center\"><b>Total</b></p></th>
						</tr>
					";
					$i=1;
					$jumlah_vtot=0;
					foreach($data_pemeriksaan as $row){
						...
						<tr>
						  	<td><p align=\"center\">$i</p></td>
						  	<td><p align=\"center\">$row->no_lab</p></td>
						  	<td><p align=\"center\">".date("h:i | d-m-Y",strtotime($row->tgl_kunjungan))."</p></td>
						  	<td>$row->jenis_tindakan</td>
						  	<td><p align=\"right\">".number_format( $row->biaya_lab, 2 , ',' , '.' )."</p></td>
						  	<td><p align=\"center\">$row->qty</p></td>
						  	<td><p align=\"right\">$vtot</P></td>
			...
			// $file_name="FKTR_$no_lab.pdf";
			$file_name="FKTR_LAB_".$no_register."_".$data_pasien->nama.".pdf";
				/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				tcpdf();
