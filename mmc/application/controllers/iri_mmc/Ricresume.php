...
class Ricresume extends Secure_area {
	...
	public function simpan_resume(){
		...
		$data_pendaftaran['diagpost']=$this->input->post('nm_diagpost');
		...
		$data_pendaftaran['tgl_kontrol']=$this->input->post('tgl_kontrol');
	...
	public function pdf_resume($no_ipd=''){
		...
		if($pasien[0]['carabayar']=='BPJS'){
			$sep="<tr>
				<td><b>No SEP</b></td>
				<td> : ".$pasien[0]['no_sep']."</td>
			</tr>";
		}
		$konten = " ".$this->config->item('header_pdf')."
		<hr><br/><br/>
		<table >
			<tr>
				<td></td>
				<td></td>
				<td></td>
				<td><b>Tanggal-Jam: ".date("j F Y H:i")."</b></td>
			</tr>
		</table>
		<br/>
		<p align=\"center\"><b>
		...
		<table width=\"500\">
			...
			<tr>
				<td><b>Tgl. Lahir</b></td>
				<td> : ".date("j F Y", strtotime($pasien[0]['tgl_lahir']))." / ".$interval->format("%Y Tahun, %M Bulan, %d Hari")."</td>
			</tr>
			<tr>
		...
		<table border="1">
			<tr>
				...
				<td align="left">  '.date("d-m-Y", strtotime($pasien[0]['tgl_masuk'])).'</td>
				<td align="left">  Tgl. Meninggal</td>
				<td align="left">  -</td>
			</tr>
			<tr>
				<td align="left">  Keadaan Datang</td>
				<td align="left">  '.$pasien[0]['id_smf'].'</td>
				<td align="left">  Ruang</td>
				<td align="left">  '.$pasien[0]['nmruang'].' / '.$pasien[0]['idrg'].'</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td align="left" >  '.$pasien[0]['diagmasuk'].' - '.$pasien[0]['nm_diagmasuk'].'</td>
				<td align="left">  Kode ICD 9</td>
				<td align="left">  '.$pasien[0]['procmasuk'].'</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td align="left">  '.$pasien[0]['riwpenyakit'].'</td>
				<td align="left">  Diagnosa Post Tindakan</td>
				<td align="left">  '.$pasien[0]['diagpost'].'</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td align="left">  '.date("d-m-Y", strtotime($pasien[0]['tgl_keluar'])).'</td>
				<td align="left">  Tgl Kontrol</td>
				<td align="left">  '.date("d-m-Y", strtotime($pasien[0]['tgl_kontrol'])).'</td>
			</tr>
		</table>
		<br><br>
		<table>
			<tr>
				<td></td>
				<td></td>
				<td>'.$this->config->item('kota').', '.date("d-m-Y").'</td>
			</tr>
			<tr>
				<td></td>
				<td></td>
