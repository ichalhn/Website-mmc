...
class Rickwitansi extends Secure_area {
	...
	public function detail_kwitansi($no_ipd=''){
		...
		$data['biaya_daftar'] = $biaya_daftar;
		 $data['grand_total_pembulatan'] = $data['grand_total_pembulatan'] + $data['biaya_administrasi'] + $jasa_perawat + $biaya_daftar + 6000;
		 $data['grand_total'] = $data['grand_total'] + $data['biaya_administrasi'] + $jasa_perawat + $biaya_daftar + 6000;
		 //echo $data['grand_total'];
		//tambah cara bayar
		$data['cara_bayar']=$this->rimcara_bayar->get_all_cara_bayar();
		$data['title']='Kwitansi Pasien Rawat Inap';
